...
def realizar_cadastro():
    limpartela()
    print("Antes de realizar o cadastro é necessário confirmar a identidade do administrador do software!")
    sleep(2)
    senha_adm = input("Digite a senha do administrador do software: ")
    while senha_adm not in ("mok12345mok", "adm123"):
        limpartela()
        senha_adm = input("Digite a senha do administrador do software: ")

    if senha_adm in ("mok12345mok", "adm123"):
        pass
