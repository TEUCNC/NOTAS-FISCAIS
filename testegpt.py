...
def main():
    ...
    if mes_atual in workbook.sheetnames:
        ...
        sheet_atual[f'B{proxima_linha}'] = "nome"
        sheet_atual[f'C{proxima_linha}'] = "CPF/CNPJ"
        sheet_atual[f'D{proxima_linha}'] = "Telefone"
        sheet_atual[f'E{proxima_linha}'] = "DATA/HORA DA COMPRA"
        sheet_atual[f'F{proxima_linha}'] = "ITENS"
        sheet_atual[f'G{proxima_linha}'] = "CATEGORIA"
        sheet_atual[f'H{proxima_linha}'] = "FORMA DE PAGAMENTO"
        sheet_atual[f'I{proxima_linha}'] = "MODALIDADE DE VENDA"
